    ...
    <Documentation>
      ...
      <Section>
        ...
        <Paragraph>
          ...
          or using our service, you agree to be bound by these terms. If you
      ...
      <Section>
        ...
        <Paragraph>
          ...
          entertainment and educational purposes only. No real money is involved
          in any of the games. You are provided with "play money" that has no
          real-world value.
        </Paragraph>
        <Paragraph>
          You must be at least 18 years old or of legal age for gambling in your
      ...
      <Section>
        ...
        <Paragraph>
          ...
          and will remain the exclusive property of SimCasino.club and its
          licensors.
        </Paragraph>
      </Section>
      <Section>
